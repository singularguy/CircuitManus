...
class LLMInterface:
    ...
    def __init__(self, agent_instance: 'CircuitDesignAgentV7', model_name: str = "glm-z1-flash", default_temperature: float = 0.1, default_max_tokens: int = 4095):
...
#             model_name="glm-z1-flash", # 使用推荐的 flash 模型
